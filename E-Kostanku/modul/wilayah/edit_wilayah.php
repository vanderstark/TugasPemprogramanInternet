...
<?php
   ...
   $sql1=mysql_query("select * from wilayah where kd_wil='$_GET[id]'");
   $edt=mysql_fetch_row($sql1);
?>
<form method="post" action="<?php $_SERVER['PHP_SELF']; ?>">
  ...
  <tr>
    ...
    <td align="left" valign="top"><input type="text" value="<?php echo"$edt[2]"; ?>" size="35" name="wilayah" /></td>
  </tr>
  <tr>
    <td align="left" valign="top">&nbsp;</td>
    <td align="left" valign="top">&nbsp;</td>
...
<?php
     if(isset($_POST['simpan']))
	 {
		...
		$nama=$_POST['wilayah'];
		   ...
		   mysql_query("update wilayah set j_wil='$jns', nm_wil='$nama' where kd_wil='$_GET[id]'");
	 }
